...
/**
 * Test which issues an HTTPS GET request without verifying the chain of trust of the SSL certificate presented by
 * the server.
 */
public class NoSslCertificateChainOfTrustCheckTest extends BackgroundTest {
  ...
  protected void runTest() throws Exception {
    ...
    try {
      ...
      if (!HttpsURLConnection.getDefaultHostnameVerifier().verify(HOST, sslSession)) {
        throw new SSLPeerUnverifiedException("Server's SSL certificate does not match " + HOST);
      }
